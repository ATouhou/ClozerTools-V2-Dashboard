...
<html>
    ...
    if ("-ms-user-select" in document.documentElement.style && navigator.userAgent.match(/IEMobile\/10\.0/)) {
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/icons.css');?>"/>    
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/main.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/appframework.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/android.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/win8.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/bb.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/ios.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/ios7.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/af.ui.css');?>"title="win8" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/badges.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/buttons.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/lists.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/forms.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/src/grid.css');?>" />

      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('plugins/css/af.actionsheet.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('plugins/css/af.popup.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('plugins/css/af.selectBox.css');?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo URL::to_asset('css/custom-mobile.css');?>" />
...
-->
        ...
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('appframework.js');?>"></script>
        ...
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.actionsheet.js"></script>
         <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.css3animate.js"></script>
         <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.passwordBox.js"></script>
          <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.scroller.js"></script>
           <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.selectBox.js"></script>
            <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.touchEvents.js"></script>
          <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.touchLayer.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.popup.js"></script>

        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>src/appframework.ui.js"></script>
        <!-- <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/all.js"></script> -->
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/fade.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/flip.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/pop.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/slide.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/slideDown.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('ui/');?>transitions/slideUp.js"></script>
        <script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('plugins/');?>af.slidemenu.js"></script>
        ...
        <div ng-app="" id="afui" class="">
            ...
            <div id="content">
                <div title='Home Screen' id="main" class="panel" selected="true" data-load="loadedPanel" data-unload="unloadedPanel" data-tab="navbar_home">
                    <h2 >Welcome <?php echo ucfirst(Auth::user()->firstname);?></h2>
                    ...
                    <h4 style="margin-left:10px;">APPOINTMENT SUMMARY</h4>
                    	<div class="largestats">
                    		<div class="bignum2 BOOK"><?php echo $stats[0]->total;?></div><br/>
                    		APP
                    	</div>
                    	<div class="largestats">
                    		<div class="bignum2 PUTON"><?php echo $stats[0]->dispatched;?></div><br/>
                    		DISP
                    	</div>
                    	<div class="largestats">
                    		<div class="bignum2 PUTON"><?php echo $stats[0]->puton;?></div><br/>
                    		PUTON
                    	</div>
                    	<div class="largestats">
                    		<div class="bignum2 SOLD"><?php echo $stats[0]->sold;?></div><br/>
                    		SOLD
                    	</div>
                    	<div class="largestats">
                    		<div class="bignum2 DNS2"><?php echo $stats[0]->dns;?></div><br/>
                    		DNS
                    	</div>
                    </div>
                    <?php };?>
                ...
                <div ng-controller="ApptController" title="Demos" id="demos" class="panel"  data-header="apptheader">
                    ...
                    <h1>{{data.message}}</h1>
                  <h2>Appointments for <?php echo date('D M-d');?></h2>
                    <ul class="list">
                     	<?php foreach($appts as $v){;?>
                     		<li id="<?php echo $v->id;?>" class="<?php echo $v->status;?>" style="border-bottom:2px solid #1f1f1f;" onclick='getRepMenu(<?php echo $v->id;?>)'>
                     		<a href="#repmenu" data-id="<?php echo $v->id;?>">
                     			<span class="label label-time"><?php echo date('h:i a', strtotime($v->app_time));?></span>
                     			<span class="label label-name"><?php echo $v->lead->cust_name;?></span>
                     			<span class="label label-number"><?php echo $v->lead->cust_num;?></span>
                     			<br/><br/>
                     			<span style="font-size:12px;color:#000"><b><?php echo $v->lead->address;?></b></span><br/><br/>
                     			Dispatched To : <span id="rep-<?php echo $v->id;?>" class="label label-dispatch"><?php echo $v->rep_name;?></span>
                     			<span id="status-<?php echo $v->id;?>" class="status"><?php echo $v->status;?></span>
                     			</a>
                     		</li>
                     	<?php };?>
                    </ul>
                  ...
                  <h2 >Available Leads to Assign</h2>
                    <ul class="list">
                     	<?php foreach($cities as $v){
                     		if($v->avail>0){;?>
                     		<li id="" class="" style="font-size:10px;border-bottom:2px solid #1f1f1f;" onclick="getAssignLeads('<?php echo $v->city;?>')">
                     		<a href="#assignleads" data-city="">
                     			<span class="label" style="font-sie:9px!important"><?php echo strtoupper($v->city);?></span>
                     			<span id="avail-<?php echo $v->city;?>" class="label label-avail" style="float:right;"><?php echo $v->avail;?></span>
                     			<span id="ma-<?php echo $v->city;?>" class="label label-lead manilla ">MA-<?php echo $v->paper;?></span><span id="door-<?php echo $v->city;?>" class="label label-lead door">DR-<?php echo $v->door;?></span>
                ...
                <h5><span class='label label-avail assignHead' style="margin-left:-0px;padding:5px;ont-size:15px;float:left;">Assign Nanaimo Leads
                	...
                	<option value=""></option>
                		...
                		<option value="<?php echo $val->id;?>"><?php echo $val->firstname;?> <?php echo $val->lastname;?></option>
                		<?php };?>
                	</select>
            ...
            <div id="navbar" style='margin: 0;float:left;'>
                <a href="#demos" class='icon location'>DEMOS<span class='af-badge lr'><?php echo count($appts);?></span></a><a href="#leadmanager" class="icon phone">LEADS</a>
                 ...
                 <li class="divider">Leads</li>
                   ...
                   <li style="height:400px">
                   	<div class="sysalerts">
                   		...
                   		<?php foreach($alerts as $b){;?>
                   		<div class='sysalert'><?php echo $b->message;?></div>
                   		<?php };?>
...
<script src="<?php echo URL::to_asset('js/include/gmap3.min.js');?>"></script>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
<script src="<?php echo URL::to_asset('js/include/guage.min.js');?>"></script>
<script type="text/javascript" charset="utf-8" src="<?php echo URL::to_asset('js/angular.min.js');?>"></script>
<script type="text/javascript">
function ApptController($scope){
