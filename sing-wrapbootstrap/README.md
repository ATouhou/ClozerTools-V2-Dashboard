...
Available in two versions: [**basic ajax**](http://demo.flatlogic.com/sing-wrapbootstrap/ajax/) and [**Angular js**](http://demo.flatlogic.com/sing-wrapbootstrap/angular/)!
